...
#are specified in XML in a separate file.
#
...
#though the targetFile element is handled outside of this script.
#
...
if args.xml is None or args.patch_xml is None or args.output_xml is None:
    parser.print_usage()
    sys.exit(-1)
...
print "\nCreated patched file " + args.output_xml
